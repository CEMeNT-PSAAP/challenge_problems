...
# Core cell
# Surfaces
cy0 = mcdc.surface("cylinder-z", center=[0.0, 0.0], radius=93.98)
cy1 = mcdc.surface("cylinder-z", center=[0.0, 0.0], radius=99.06)
cy2 = mcdc.surface("cylinder-z", center=[0.0, 0.0], radius=122.555)
cy3 = mcdc.surface(
    "cylinder-z", center=[0.0, 0.0], radius=133.35, bc="vacuum"
)
zlo = mcdc.surface("plane-z", z=-141.616, bc="vacuum")
zup = mcdc.surface("plane-z", z=141.616, bc="vacuum")
# Cell
core = mcdc.cell([-cy0, +zlo, -zup], lattice_core)
barrel = mcdc.cell([+cy0, -cy1, +zlo, -zup], mat_gt)
downcomer = mcdc.cell([+cy1, -cy2, +zlo, -zup], mat_mod)
vessel = mcdc.cell([+cy2, -cy3, +zlo, -zup], mat_gt)

# Root universe
mcdc.universe([core, barrel, downcomer, vessel], root=True)
